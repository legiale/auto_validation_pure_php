...
<html>
    ...
    <body>
        ...
        <div style="text-align: center;" id="container">
            <div style="display: inline-block; width : 800px ; background-color: #b2ffe5; padding: 25px !important;">
                <form action="" name="test" method="post">
                    <p style="float: left">full_name:</p>
                    <p>
                        <input check_validate="on" class="form-control" type="text" name="full_name__Ak3K10R">
                    <p class="text-danger" id="full_name__Ak3K10R_error_place">x<?php  ?></p>
                    </p>
