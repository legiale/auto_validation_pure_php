    ...
    public function parse_rule($form_data) {
        ...
        foreach ($form_data as  $key => $value) {
            ...
            if (isset($field_item[1])) {
                ...
                // print_r($field_item[1]);
            }
        }
    }


    public function parse_rule_le($form_data, $error_message_array = null) {
        // Load the language file containing error messages
        $this->CI->lang->load('form_validation');
        $trans_rules_list = [
            "A" => "alpha",
